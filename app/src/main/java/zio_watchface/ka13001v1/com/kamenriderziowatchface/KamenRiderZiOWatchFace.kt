package zio_watchface.ka13001v1.com.kamenriderziowatchface
 ...
 */
class KamenRiderZiOWatchFace : CanvasWatchFaceService() {

    override fun onCreateEngine(): Engine {
        return Engine()
    }

    private class EngineHandler(reference: KamenRiderZiOWatchFace.Engine) : Handler() {
        private val mWeakReference: WeakReference<KamenRiderZiOWatchFace.Engine> = WeakReference(reference)
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(WatchFaceStyle.Builder(this@KamenRiderZiOWatchFace)
        ...
        private fun getBitmapFromVector(drawable: Int): Bitmap {
            val drawable = ContextCompat.getDrawable(this@KamenRiderZiOWatchFace, drawable)
        ...
        private fun initializeBackground() {
            ...
            mBackgroundBitmap = getBitmapFromVector(R.drawable.bg_zi_o_magenta_gradient)
        ...
        override fun onSurfaceChanged(holder: SurfaceHolder, format: Int, width: Int, height: Int) {
            ...
            val minute = getBitmapFromVector(R.drawable.hand_zio_minute)
            sMinuteHandLength = minute.height.toFloat()
//            sMinuteHandLength = (mCenterX * 0.75).toFloat()
            val hour = getBitmapFromVector(R.drawable.hand_zio_hour)
            sHourHandLength = hour.height.toFloat()
        ...
        private fun drawWatchFace(canvas: Canvas) {
            ...
            val hour = getBitmapFromVector(R.drawable.hand_zio_hour)
            canvas.drawBitmap(hour, mCenterX - (2 * CENTER_GAP_AND_CIRCLE_RADIUS), mCenterY - sHourHandLength, mHourPaint)
//            canvas.drawLine(
//                    mCenterX,
...
//                    mHourPaint)
            ...
            val minute = getBitmapFromVector(R.drawable.hand_zio_minute)
            canvas.drawBitmap(minute, mCenterX - (2 * CENTER_GAP_AND_CIRCLE_RADIUS), mCenterY - sMinuteHandLength, mMinutePaint)
//            canvas.drawLine(
//                    mCenterX,
//                    mCenterY - CENTER_GAP_AND_CIRCLE_RADIUS,
//                    mCenterX,
...
//                    mMinutePaint)
        ...
        private fun registerReceiver() {
            ...
            this@KamenRiderZiOWatchFace.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@KamenRiderZiOWatchFace.unregisterReceiver(mTimeZoneReceiver)
        }
